// Write a function that takes array of any number of cards (poker cards, 52 unique cards) and returns 
// the number of complete decks we can make using those cards.
